...
// Extension-qualified: these are VALUE imports and the tests reach this module
// through Node's test runner, which strips types but resolves specifiers
// literally — see the allowImportingTsExtensions note in tsconfig.json.
import { COLLECTOR_VERSION, ENV_COLLECTOR_VERSION } from "./collectorVersion.ts";

// Re-exported so existing callers (lib/handbook) are unaffected by the split.
export { COLLECTOR_VERSION, ENV_COLLECTOR_VERSION };
